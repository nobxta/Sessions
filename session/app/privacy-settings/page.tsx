...
export default function PrivacySettings() {
  ...
  const [privacySettings, setPrivacySettings] = useState<Record<string, { enabled: boolean; value: string }>>({});
  ...
  const handleSettingValueChange = (settingId: string, value: string) => {
    setPrivacySettings(prev => ({
      ...prev,
      [settingId]: {
        ...prev[settingId],
                        ...
                        {isSuccess && result.applied_settings && (
                          <div className="mt-2 text-sm text-gray-300">
                            ...
                            <ul className="list-disc list-inside space-y-0.5">
                              {result.applied_settings.map((setting: any, idx: number) => (
