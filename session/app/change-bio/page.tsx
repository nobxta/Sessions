...
export default function ChangeBio() {
  ...
  const [bioInputs, setBioInputs] = useState<Record<number, string>>({});
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if ((err as any)?.name !== 'AbortError') setError(err.message || 'Failed to update bios');
    } finally {
      setIsUpdating(false);
    }
  };
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            ...
            <PageHelpLink href="/docs/name-bio-changer" />
          </div>
          <div>
