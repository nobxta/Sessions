  ...
  const dashboardOptions = [
    {
      ...
      title: 'Session Maker',
      icon: Plus,
      onClick: () => navigate('/session-maker')
    },
    {
      id: 'validate-sessions',
      title: 'Validate Sessions',
      icon: ShieldCheck,
      onClick: () => navigate('/validate-sessions')
    },
    {
      id: 'change-name',
      title: 'Change Name',
    ...
    },
    {
      ...
      title: 'Join Folders',
      icon: FolderPlus,
      onClick: () => navigate('/join-chatlists')
    },
    {
      id: 'leave-all-groups',
      title: 'Leave All Groups',
      icon: LogOut,
      onClick: () => navigate('/leave-all-groups')
    },
    {
      id: 'change-session-string',
      title: 'Session Converter',
      icon: Code,
      onClick: () => navigate('/session-converter')
    },
    {
      id: 'code-extractor',
      title: 'Code Extractor',
      icon: Key,
      onClick: () => navigate('/code-extractor')
    },
    {
      id: 'tgdna-checker',
      title: 'Age Checker, Creation year',
      icon: Calendar,
      onClick: () => navigate('/tgdna-checker')
    },
    {
      id: 'spambot-checker',
      title: 'SpamBot Checker',
      icon: Shield,
      onClick: () => navigate('/spambot-checker')
    },
    {
      id: 'session-metadata',
      title: 'Session Metadata Viewer',
      icon: Info,
      onClick: () => navigate('/session-metadata')
    }
  ];
