...
const ValidateSessions = () => {
  ...
  const handleFileSelect = async (selectedFiles) => {
    ...
    try {
      // Extract sessions from all files
      const allSessions = [];
  ...
  const handleValidate = () => {
    ...
    ws.onopen = () => {
      // Send validation request with session paths
      // Combine all temp directories from multiple files
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Results Display - Show immediately when validation starts */}
