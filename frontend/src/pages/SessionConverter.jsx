...
const SessionConverter = () => {
  ...
  const [mode, setMode] = useState('to-string'); // 'to-string' or 'to-session'
  ...
  // String to Session mode
  const [sessionStrings, setSessionStrings] = useState([{ name: '', string: '' }]);
  ...
  const handleRemoveStringField = (index) => {
